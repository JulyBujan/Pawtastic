document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (idMascota) {
        ...
        // MODO CREACIÓN (ya está configurado por defecto en el HTML)
        console.log("Modo: Crear nueva mascota.");
    }

    // --- Configuración para el Modo Edición ---
    async function setupEditMode(id) {
        // Cambiar textos en la UI
        document.getElementById('page-title').textContent = 'Editar Mascota | Pawtastic';
        ...
        document.getElementById('foto-label').textContent = 'Cambiar Foto (opcional)';
