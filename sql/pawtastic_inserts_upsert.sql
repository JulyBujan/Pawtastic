-- Inserts with ON DUPLICATE KEY UPDATE (generated)
...
ON DUPLICATE KEY UPDATE `id`=VALUES(`id`), `id_usuario`=VALUES(`id_usuario`), `id_mascota`=VALUES(`id_mascota`), `id_ong`=VALUES(`id_ong`), `comentarios`=VALUES(`comentarios`), `estado`=VALUES(`estado`), `fecha_inicio`=VALUES(`fecha_inicio`), `fecha_fin`=VALUES(`fecha_fin`), `fecha_actualizacion`=VALUES(`fecha_actualizacion`);
...
ON DUPLICATE KEY UPDATE `id`=VALUES(`id`), `id_ong`=VALUES(`id_ong`), `nombre`=VALUES(`nombre`), `tipo`=VALUES(`tipo`), `edad`=VALUES(`edad`), `sexo`=VALUES(`sexo`), `tamaño`=VALUES(`tamaño`), `vacunado`=VALUES(`vacunado`), `esterilizado`=VALUES(`esterilizado`), `chip`=VALUES(`chip`), `apto_ninos`=VALUES(`apto_ninos`), `apto_mascotas`=VALUES(`apto_mascotas`), `descripcion`=VALUES(`descripcion`), `breed`=VALUES(`breed`), `color`=VALUES(`color`), `imagen`=VALUES(`imagen`), `energia`=VALUES(`energia`), `sociabilidad`=VALUES(`sociabilidad`), `presencia`=VALUES(`presencia`), `estilov`=VALUES(`estilov`), `estado`=VALUES(`estado`), `date_update`=VALUES(`date_update`), `date_publicacion`=VALUES(`date_publicacion`);
...
(60, 10, '2026-01-15'),
(13, 11, '2023-06-04')
ON DUPLICATE KEY UPDATE `id_mascota`=VALUES(`id_mascota`), `id_vacuna`=VALUES(`id_vacuna`), `fecha_aplicacion`=VALUES(`fecha_aplicacion`);
...
ON DUPLICATE KEY UPDATE `id`=VALUES(`id`), `nombre`=VALUES(`nombre`), `razon_social`=VALUES(`razon_social`), `cuit`=VALUES(`cuit`), `lat`=VALUES(`lat`), `lon`=VALUES(`lon`), `city`=VALUES(`city`), `suburb`=VALUES(`suburb`), `road`=VALUES(`road`), `house_number`=VALUES(`house_number`), `departamento`=VALUES(`departamento`), `fecha_constitucion`=VALUES(`fecha_constitucion`), `ultima_actualizacion`=VALUES(`ultima_actualizacion`);
...
ON DUPLICATE KEY UPDATE `id`=VALUES(`id`), `email`=VALUES(`email`), `password`=VALUES(`password`), `tipo`=VALUES(`tipo`), `ong_id`=VALUES(`ong_id`), `nombre`=VALUES(`nombre`), `apellido`=VALUES(`apellido`), `tipo_documento`=VALUES(`tipo_documento`), `documento`=VALUES(`documento`), `telefono`=VALUES(`telefono`), `foto_perfil_url`=VALUES(`foto_perfil_url`), `fecha_nacimiento`=VALUES(`fecha_nacimiento`), `sexo`=VALUES(`sexo`), `lat`=VALUES(`lat`), `lon`=VALUES(`lon`), `city`=VALUES(`city`), `suburb`=VALUES(`suburb`), `road`=VALUES(`road`), `house_number`=VALUES(`house_number`), `departamento`=VALUES(`departamento`), `tipo_casa`=VALUES(`tipo_casa`), `otras_mascotas`=VALUES(`otras_mascotas`), `experiencia`=VALUES(`experiencia`), `energia`=VALUES(`energia`), `sociabilidad`=VALUES(`sociabilidad`), `presencia`=VALUES(`presencia`), `estilov`=VALUES(`estilov`), `ultima_actualizacion`=VALUES(`ultima_actualizacion`), `fecha_registro`=VALUES(`fecha_registro`), `estado`=VALUES(`estado`), `tokenv`=VALUES(`tokenv`);
...
ON DUPLICATE KEY UPDATE `id_vacuna`=VALUES(`id_vacuna`), `nombre`=VALUES(`nombre`), `tipo`=VALUES(`tipo`), `descripcion`=VALUES(`descripcion`);
